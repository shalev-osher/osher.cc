...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "hero.viewCV": { en: "View CV", he: "צפה בקו\"ח" },
  "hero.downloadPdf": { en: "Download PDF", he: "הורד PDF" },
  "hero.cvPreview": { en: "CV Preview", he: "תצוגה מקדימה של קו\"ח" },
