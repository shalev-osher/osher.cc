...
const certifications = [
  { name: "Certified Hands-On Cyber Security Specialist", details: "MCSA + Linux (450 Hours)", year: "2023" },
];
          ...
          <AnimatedSection delay={0.2}>
            <div className="space-y-6">
              ...
              {certifications.map((cert) => (
                <div key={cert.name} className="card-elevated p-6 hover:border-primary/50 border border-transparent transition-all duration-300">
                  <h4 className="font-display text-lg font-semibold mb-2">{cert.name}</h4>
